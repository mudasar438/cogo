  ...
  return (
    <>
      <div
        ...
        className="absolute text-[#fff]  bg-[#16161b] py-3 px-1   top-[150px] md:top-[40px]  border border-[#303030] rounded-xl w-[300px]  md:w-[280px] none flex flex-col md:flex-row justify-between  items-start "
      >
