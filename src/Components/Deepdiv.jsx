...
export const Deepdiv = () => {
  return (
    <>
      <div style={{ fontFamily: "Regular" }} className="mt-[100px]">
        <div className="deepbg"></div>
        <div className=" flex w-full p-5 md:w-[80%] mx-auto  -mt-[400px] md:-mt-[80px] ">
          <div className=" w-full space-y-16">
            <p
              style={{ fontFamily: "Regular" }}
              className="text-3xl md:text-4xl lg:text-6xl w-full md:w-[58%] text-center md:text-left "
            >
